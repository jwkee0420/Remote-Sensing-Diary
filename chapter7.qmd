...
![*Figure 1: Random (top) and spatial partitioning (bottom) of test and training data. Source: [Lovelace et al., 2022](https://bookdown.org/robinlovelace/geocompr/spatial-cv.html)*](images/cv.png){fig-align="center" width="700"}
